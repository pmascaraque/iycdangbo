export function Dangbo() {
    return (
      <p><br/>TEST1<br/><br/>Dangbo es una localidad situada en la Región de Ouemé, al sur de Benín con una población de 77000 habitantes en una Superficie de 340 kms  cuadrados, con una estructura sanitaria deficitaria e insuficiente.
      ...
      <br/>La mortalidad infantil, la desnutrición y las enfermedades infecciosas son la primera causa de mortalidad<br/><br/><br/></p>
  ...
  export function Help() {
    return (
      <p><br/><br/>TEST3    <br/>Lo habitan nueve millones de habitantes, franco-parlantes, pertenecientes a más de siete etnias que comparten por igual la belleza del país y la pobreza extrema, que lo coloca en los últimos puestos de desarrollo humano. IDH (índice desarrollo humano): puesto 172. La relación de médicos por habitante es de 0.1 cada 1000 (España 4.9), habiendo 0.2 camas por cada 1000 habitantes. (España 3.2)
  ...
  export function Work() {
    return (
      <p><br/><br/>TEST2<br/><br/>
Fundada en febrero de 2014    <br/>Lo habitan nueve millones de habitantes, franco-parlantes, pertenecientes a más de siete etnias que comparten por igual la belleza del país y la pobreza extrema, que lo coloca en los últimos puestos de desarrollo humano. IDH (índice desarrollo humano): puesto 172. La relación de médicos por habitante es de 0.1 cada 1000 (España 4.9), habiendo 0.2 camas por cada 1000 habitantes. (España 3.2)
      ...
      Cuenta con una Maternidad con Sala de Partos, elemental, sin posibilidad de realizar cesáreas atendida por una Hermana Matrona y tres Matronas más. La Comunidad de Religiosas se ocupa del Laboratorio, de la Farmacia y del apoyo en todas las tareas del Hospital.
      
      Comenzamos dos Cirujanos y un Anestesista en febrero de 2014. A febrero de 2016 hemos realizado seis Campañas, dos Pediátricas exclusivas, tres de Cirugía General y una de Ginecología y Cirugía Pediátrica, operando más de treinta pacientes por Campaña. Para 2016 pensamos realizar cuatro Campañas más.
      
      Llevamos con nosotros todo el material quirúrgico, instrumental y material fungible (desechable), así como aparataje anestésico. El resto de las necesidades, son cubiertas por el Hospital, por ejemplo: ropa de quirófano, gasas y compresas, esterilización del material quirúrgico entre una y otra operación, lo que conlleva coordinación por parte del personal de quirófano y un no despreciable consumo y coste de electricidad.</p>
    );
  }