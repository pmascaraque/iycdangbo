export default {
  ...
  dangbo: {
    text: [
      "Dangbo es una localidad al sur de Benín con una población de 77.000 habitantes .La Republica de Benín es un Estado de África Occidental  situado en el Golfo de Guinea. ",
      "Lo habitan nueve millones de habitantes, franco-parlantes, pertenecientes a más de siete etnias que comparten por igual la belleza del país y la pobreza extrema, colocándose en los últimos puestos de desarrollo humano. IDH (índice desarrollo humano): puesto 172. La relación de médicos por habitante es de 0.1 cada 1000 (España 4.9), habiendo 0.2 camas por cada 1000 habitantes (España 3.2). La mortalidad infantil, la desnutrición y las enfermedades infecciosas son la primera causa de mortalidad."
    ],
    images: [
